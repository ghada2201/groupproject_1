...
public class main {
    ...
    public static void main(String[] args) {
       ...
       //table.creatingtable(); to test if the table is been created 
        ...
        //ReadingData.insert(18593, "E", 2005, "12/10/2005", 8, 11, "North East", 171, "Redcar and Cleveland", "A171", "Major", "A1043", "A173", 455000, 515662, "54.53325664", "-1.15156771", "4.1", "2.55", 3, 5, 666, 13, 141, 21, 2, 3, 2, 2, 4, 34, 859);
                //testing the insert mothed
       
        //ResultSet id = ReadingData.get(16712); testing the get mothed
       
        //ArrayList<String> fileContenta = CSVReader.readFile("file.CSV"); ubloding the data
        
        //ReadingData.batchInsert(fileContenta); reading the data 
